...
var Rose_alpha = "abcdefghijklmnopqrstuvwxyz";
var Rose_PUNCT = "!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~";
var Rose_ASCII = Rose_DECIMAL + Rose_ALPHA + Rose_alpha + Rose_PUNCT; // 制御コードと空白を含まない。
var Rose_KANA = "｡｢｣､･ｦｧｨｩｪｫｬｭｮｯｰｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝﾞﾟ";
var Rose_HALF = Rose_ASCII + Rose_KANA;

var Rose_MBC_HIRA = "ぁあぃいぅうぇえぉおかがきぎくぐけげこごさざしじすずせぜそぞただちぢっつづてでとどなにぬねのはばぱひびぴふぶぷへべぺほぼぽまみむめもゃやゅゆょよらりるれろゎわゐゑをん";
var Rose_MBC_KANA = "ァアィイゥウェエォオカガキギクグケゲコゴサザシジスズセゼソゾタダチヂッツヅテデトドナニヌネノハバパヒビピフブプヘベペホボポマミムメモャヤュユョヨラリルレロヮワヰヱヲンヴヵヶー";

var Rose_MBC_BINADECIMAL = "０１";
var Rose_MBC_OCTODECIMAL = "０１２３４５６７";
var Rose_MBC_DECIMAL     = "０１２３４５６７８９";
var Rose_MBC_HEXADECIMAL = "０１２３４５６７８９ＡＢＣＤＥＦ";
var Rose_MBC_hexadecimal = "０１２３４５６７８９ａｂｃｄｅｆ";
