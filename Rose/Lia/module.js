...
console.log("C:/Dev/Riot/Lunarwalk/Rose/Rose/src/Rose/Visitor.js (4)"); // @:LOGPOS

	Rose_Visitor_Count++;
}

function Rose_Visitor_Leave() {
console.log("C:/Dev/Riot/Lunarwalk/Rose/Rose/src/Rose/Visitor.js (10)"); // @:LOGPOS
if(Rose_Visitor_Count < 1) { console.error("C:/Dev/Riot/Lunarwalk/Rose/Rose/src/Rose/Visitor.js (11)"); } // @:errorCase
